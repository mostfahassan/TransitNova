...
public static class AdminDisplay
{
    ...
    public static string BadgeClass(string value)
    {
        ...
        if (text.Contains("active") || text.Contains("delivered") || text.Contains("approved") || text.Contains("success") || text.Contains("available") || text == "yes")
            return "admin-badge admin-badge-success";

        if (text.Contains("pending") || text.Contains("transit") || text.Contains("review") || text.Contains("busy") || text.Contains("assigned"))
