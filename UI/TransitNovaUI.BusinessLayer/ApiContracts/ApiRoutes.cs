...
public static class ApiRoutes
{
    ...
    public static class UserBundles
    {
        public const string GetUserBundleByIdUrl = $"{Prefix}/users/bundles/{{bundleId}}";
        public const string GetUserBundlesUrl = $"{Prefix}/users/bundles";
    }
