...
{
    [Fact]
    public async Task GetNewTokenAsync_Should_ThrowNotFound_When_RefreshTokenDoesNotExistAsync()
    {
    ...
    [Fact]
    public async Task GetNewTokenAsync_Should_ThrowInvalidToken_When_RefreshTokenIsExpiredAsync()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task GetNewTokenAsync_Should_ThrowNotFound_When_TokenUserIsMissingAsync()
    {
        var fixture = new Fixture();
        var token = ValidToken();
        token.User = null;
    ...
    [Fact]
    public async Task GetNewTokenAsync_Should_RevokeAllAndThrowReuseException_When_TokenWasRevokedAsync()
    {
        var fixture = new Fixture();
        var token = ValidToken();
        ...
        await act.Should().ThrowAsync<ReusedRefreshTokenException>();
    ...
    [Fact]
    public async Task GetNewTokenAsync_Should_ThrowRevokingExceptionAndSkipPersistence_When_OldTokenCannotBeRevokedAsync()
    {
        var fixture = new Fixture();
        var token = ValidToken();
        ...
        await act.Should().ThrowAsync<RevokingRefreshTokenException>();
    ...
    [Fact]
    public async Task GetNewTokenAsync_Should_RotatePersistAndReturnTokens_When_RefreshTokenIsValidAsync()
    {
        var fixture = new Fixture();
        var token = ValidToken();
        fixture.Tokens.Setup(x => x.GetRefreshTokenAsync("old", It.IsAny<CancellationToken>())).ReturnsAsync(token);
        ...
        fixture.Provider.Setup(x => x.GenerateTokenAsync(token.User!)).ReturnsAsync("new-access");
