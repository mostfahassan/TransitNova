...
{
    [Fact]
    public async Task CreateCountryHandler_Should_TrimPersistAndReturnCountry_When_RequestIsValidAsync()
    {
    ...
    [Fact]
    public async Task CreateCountryHandler_Should_PropagateExceptionAndSkipCommit_When_RepositoryFailsAsync()
    {
        var repository = new Mock<ICountryRepository>();
    ...
    [Fact]
    public async Task UpdateCountryHandler_Should_ThrowNotFoundAndSkipWrites_When_CountryDoesNotExistAsync()
    {
        var repository = new Mock<ICountryRepository>();
        var unitOfWork = new Mock<IUnitOfWork>();
    ...
    [Fact]
    public async Task UpdateCountryHandler_Should_UpdateAndCommit_When_CountryExistsAsync()
    {
    ...
    [Fact]
    public async Task DeleteCountryHandler_Should_DeleteAndCommit_When_CommandIsHandledAsync()
    {
        var repository = new Mock<ICountryRepository>();
        var unitOfWork = SuccessfulUnitOfWork();
    ...
    [Fact]
    public async Task GetCountryByIdHandler_Should_ReturnNotFound_When_RepositoryReturnsNullAsync()
    {
        var repository = new Mock<ICountryRepository>();
    ...
    [Fact]
    public async Task GetCountriesHandler_Should_ReturnEmptyCollection_When_NoCountriesExistAsync()
    {
        var repository = new Mock<ICountryRepository>();
    ...
    [Fact]
    public async Task CreateGovernmentHandler_Should_ReturnNotFoundAndSkipWrites_When_CountryDoesNotExistAsync()
    {
    ...
    [Fact]
    public async Task CreateGovernmentHandler_Should_TrimPersistAndReturnGovernment_When_CountryExistsAsync()
    {
        var governments = new Mock<IGenericRepository<Government, int>>();
        var countries = new Mock<IGenericRepository<Country, int>>();
        var unitOfWork = SuccessfulUnitOfWork();
    ...
    [Fact]
    public async Task UpdateGovernmentHandler_Should_ReturnNotFound_When_GovernmentDoesNotExistAsync()
    {
        var governments = new Mock<IGenericRepository<Government, int>>();
        var countries = new Mock<IGenericRepository<Country, int>>();
        var unitOfWork = new Mock<IUnitOfWork>();
    ...
    [Fact]
    public async Task UpdateGovernmentHandler_Should_ReturnNotFoundAndSkipUpdate_When_CountryDoesNotExistAsync()
    {
    ...
    [Fact]
    public async Task UpdateGovernmentHandler_Should_UpdateAndCommit_When_EntitiesExistAsync()
    {
        var government = Government.Create("Old", 1);
        var governments = new Mock<IGenericRepository<Government, int>>();
        var countries = new Mock<IGenericRepository<Country, int>>();
    ...
    public async Task DeleteGovernmentHandler_Should_ReturnExpectedResult_When_DeleteOutcomeIsKnownAsync(bool deleted, ResultStatus expectedStatus)
    {
    ...
    [Fact]
    public async Task GetGovernmentByIdHandler_Should_ReturnGovernment_When_EntityExistsAsync()
    {
        var repository = new Mock<IGenericRepository<Government, int>>();
    ...
    [Fact]
    public async Task GetGovernmentsHandler_Should_ReturnEmptyList_When_RepositoryIsEmptyAsync()
    {
        var repository = new Mock<IGenericRepository<Government, int>>();
    ...
    [Fact]
    public async Task CreateZoneHandler_Should_ReturnCreatedZone_When_PersistedZoneCanBeRetrievedAsync()
    {
    ...
    [Fact]
    public async Task CreateZoneHandler_Should_ReturnFailure_When_PersistedZoneCannotBeRetrievedAsync()
    {
        var repository = new Mock<IZoneRepository>();
        var unitOfWork = SuccessfulUnitOfWork();
    ...
    [Fact]
    public async Task UpdateZoneHandler_Should_ThrowNotFound_When_ZoneDoesNotExistAsync()
    {
        var repository = new Mock<IZoneRepository>();
        var unitOfWork = new Mock<IUnitOfWork>();
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task GetZoneByIdHandler_Should_ReturnNotFound_When_ZoneDoesNotExistAsync()
    {
        var repository = new Mock<IZoneRepository>();
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task GetZonesByCityHandler_Should_PreservePagination_When_RepositoryReturnsPageAsync()
    {
        var repository = new Mock<IZoneRepository>();
