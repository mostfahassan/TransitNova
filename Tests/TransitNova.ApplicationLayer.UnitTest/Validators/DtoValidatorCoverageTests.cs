...
{
    [Fact]
    public async Task CreateWarehouseDtoValidator_Should_AcceptDto_When_AllValuesAreValidAsync()
    {
    ...
    [InlineData("type")]
    [InlineData("zones")]
    public async Task CreateWarehouseDtoValidator_Should_RejectDto_When_BusinessConstraintIsInvalidAsync(string invalidField)
    {
    ...
    [Fact]
    public async Task UpdateWarehouseDtoValidator_Should_AcceptNullOperatingHours_When_OtherValuesAreValidAsync()
    {
    ...
    [Fact]
    public async Task UpdateWarehouseDtoValidator_Should_RejectDto_When_OperatingHoursIsZeroAsync()
    {
        var dto = new UpdateWarehouseDto
        {
            Name = "Warehouse",
    ...
    [Fact]
    public async Task CreateVehicleDtoValidator_Should_AcceptDto_When_AllValuesAreValidAsync()
    {
    ...
    [InlineData("carrier")]
    [InlineData("type")]
    public async Task CreateVehicleDtoValidator_Should_RejectDto_When_BusinessConstraintIsInvalidAsync(string invalidField)
    {
    ...
    public async Task LoginValidator_Should_ReturnExpectedValidity_When_CredentialsAreProvidedAsync(string password, string email, bool expected)
    {
    ...
    public async Task ChangePasswordValidator_Should_ReturnExpectedValidity_When_PasswordsAreProvidedAsync(
        string current,
        string next,
        string confirmation,
        bool expected)
    ...
    [Fact]
    public async Task RegisterUserValidator_Should_AcceptDto_When_RegistrationDataIsStrongAndCompleteAsync()
    {
    ...
    public async Task RegisterUserValidator_Should_RejectDto_When_CredentialRuleIsViolatedAsync(
        string username,
        string password,
    ...
    public async Task RegisterUserValidator_Should_RejectDto_When_ProfileFieldIsInvalidAsync(
        string email,
        string phone,
        string firstName,
        string lastName,
