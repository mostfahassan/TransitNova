...
{
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenUserCannotRate_ShouldReturnFailureWithoutSavingAsync()
    {
    ...
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenCarrierDoesNotExist_ShouldReturnNotFoundWithoutSavingAsync()
    {
        var fixture = new PickupRatingFixture();
    ...
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenRatingIsAllowed_ShouldReturnSuccessAsync()
    {
        var fixture = new PickupRatingFixture();
    ...
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenRatingIsAllowed_ShouldPersistCorrectRatingRecordAsync()
    {
        var fixture = new PickupRatingFixture();
    ...
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenRatingIsAllowed_ShouldSaveAndInvalidateThreeCachesAsync()
    {
        var fixture = new PickupRatingFixture();
        await fixture.Handler.Handle(fixture.Command, CancellationToken.None);
    ...
    [Fact]
    public async Task RatingPickupCarrierHandler_WhenCancellationTokenIsPassed_ShouldForwardItAsync()
    {
        var fixture = new PickupRatingFixture();
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenUserCannotRate_ShouldReturnFailureWithoutSavingAsync()
    {
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenCarrierDoesNotExist_ShouldReturnNotFoundWithoutSavingAsync()
    {
        var fixture = new DeliveryRatingFixture();
        fixture.Carriers.Setup(x => x.GetCarrierAsync(
                It.IsAny<Expression<Func<Carrier, bool>>>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenRatingIsAllowed_ShouldReturnSuccessAsync()
    {
        var fixture = new DeliveryRatingFixture();
        (await fixture.Handler.Handle(fixture.Command, CancellationToken.None)).IsSuccess.Should().BeTrue();
    }
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenRatingIsAllowed_ShouldPersistRatingAndCommentAsync()
    {
        var fixture = new DeliveryRatingFixture();
        CarrierRating? captured = null;
        fixture.Ratings.Setup(x => x.AddRatingAsync(It.IsAny<CarrierRating>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenRatingIsAllowed_ShouldSaveAndInvalidateThreeCachesAsync()
    {
        var fixture = new DeliveryRatingFixture();
        await fixture.Handler.Handle(fixture.Command, CancellationToken.None);
        fixture.UnitOfWork.Verify(x => x.SaveChangesAsync(CancellationToken.None), Times.Once);
    ...
    [Fact]
    public async Task RatingDeliveryCarrierHandler_WhenCancellationTokenIsPassed_ShouldForwardItAsync()
    {
        var fixture = new DeliveryRatingFixture();
        using var cancellation = new CancellationTokenSource();
        await fixture.Handler.Handle(fixture.Command, cancellation.Token);
