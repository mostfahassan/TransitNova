...
{
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenAssignmentServiceSucceeds_ShouldReturnSuccessAsync()
    {
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenCalled_ShouldForwardAllAssignmentIdentifiersAsync()
    {
        var fixture = new PickupAssignmentFixture();

        await fixture.Handler.Handle(fixture.Command, CancellationToken.None);

        fixture.Assignment.Verify(x => x.AssignPickupAsync(
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenAssignmentSucceeds_ShouldResolveManagerNameAsync()
    {
        var fixture = new PickupAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenAssignmentSucceeds_ShouldCreateAssignedActivityLogAsync()
    {
        var fixture = new PickupAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenAssignmentSucceeds_ShouldSaveAndInvalidateSixCachesAsync()
    {
        var fixture = new PickupAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenAssignmentFails_ShouldPropagateWithoutSavingAsync()
    {
        var fixture = new PickupAssignmentFixture();
        fixture.Assignment.Setup(x => x.AssignPickupAsync(
    ...
    [Fact]
    public async Task AssignShipmentPickupToCarrierHandler_WhenCancellationTokenIsPassed_ShouldForwardItAsync()
    {
        var fixture = new PickupAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenAssignmentServiceSucceeds_ShouldReturnSuccessAsync()
    {
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenCalled_ShouldForwardAllAssignmentIdentifiersAsync()
    {
        var fixture = new DeliveryAssignmentFixture();

        await fixture.Handler.Handle(fixture.Command, CancellationToken.None);

        fixture.Assignment.Verify(x => x.AssignDeliveryAsync(
            fixture.Command.ShipmentId,
            fixture.Command.OperationManagerId,
            fixture.Command.CarrierId,
            CancellationToken.None), Times.Once);
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenAssignmentSucceeds_ShouldResolveManagerNameAsync()
    {
        var fixture = new DeliveryAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenAssignmentSucceeds_ShouldCreateAssignedActivityLogAsync()
    {
        var fixture = new DeliveryAssignmentFixture();
        SystemActivityLog? captured = null;
        fixture.Logs.Setup(x => x.LogAsync(It.IsAny<SystemActivityLog>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenAssignmentSucceeds_ShouldSaveAndInvalidateSixCachesAsync()
    {
        var fixture = new DeliveryAssignmentFixture();
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenAssignmentFails_ShouldPropagateWithoutSavingAsync()
    {
        var fixture = new DeliveryAssignmentFixture();
        fixture.Assignment.Setup(x => x.AssignDeliveryAsync(
                It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task AssignShipmentDeliveryToCarrierHandler_WhenCancellationTokenIsPassed_ShouldForwardItAsync()
    {
        var fixture = new DeliveryAssignmentFixture();
        using var cancellation = new CancellationTokenSource();
    ...
    private sealed class PickupAssignmentFixture
    {
        ...
        {
            Assignment.Setup(x => x.AssignPickupAsync(
    ...
    private sealed class DeliveryAssignmentFixture
    {
        ...
        {
            Assignment.Setup(x => x.AssignDeliveryAsync(
                    Command.ShipmentId, Command.OperationManagerId, Command.CarrierId, It.IsAny<CancellationToken>()))
                .ReturnsAsync(TrackingNumber);
            Managers.Setup(x => x.GetOperationManagerNameAsync(
                    Command.OperationManagerId, It.IsAny<CancellationToken>()))
