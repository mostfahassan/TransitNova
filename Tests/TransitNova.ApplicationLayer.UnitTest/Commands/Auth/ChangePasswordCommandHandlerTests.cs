...
{
    [Fact]
    public async Task ChangePasswordHandler_WhenIdentityAcceptsPasswordChange_ShouldReturnSuccessAsync()
    {
    ...
    [Fact]
    public async Task ChangePasswordHandler_WhenCalled_ShouldUseCommandUserIdAsync()
    {
        var fixture = new ChangePasswordFixture();
    ...
    [Fact]
    public async Task ChangePasswordHandler_WhenCalled_ShouldForwardCurrentPasswordAsync()
    {
        var fixture = new ChangePasswordFixture();
    ...
    [Fact]
    public async Task ChangePasswordHandler_WhenCalled_ShouldForwardNewPasswordAsync()
    {
        var fixture = new ChangePasswordFixture();
    ...
    [Fact]
    public async Task ChangePasswordHandler_WhenCancellationTokenIsPassed_ShouldForwardItAsync()
    {
        var fixture = new ChangePasswordFixture();
    ...
    public async Task ChangePasswordHandler_WhenIdentityServiceRejectsChange_ShouldPropagateWithoutSuccessAsync(string message)
    {
        var fixture = new ChangePasswordFixture();
    ...
    private sealed class ChangePasswordFixture
    {
        ...
        {
            Command = new ChangePasswordCommand(Dto, Guid.NewGuid());
