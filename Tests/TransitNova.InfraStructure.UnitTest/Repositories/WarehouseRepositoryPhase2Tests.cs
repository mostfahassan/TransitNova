...
{
    [Fact]
    public async Task GetWarehousesAsync_ShouldReturnEmptyList_WhenNoWarehousesExistAsync()
    {
    ...
    [Fact]
    public async Task GetWarehousesAsync_ShouldOrderByName_WhenRowsExistAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetWarehouseByIdAsync_ShouldReturnProjection_WhenWarehouseExistsAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetWarehouseByIdAsync_ShouldReturnNull_WhenWarehouseDoesNotExistAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetWarehouseForUpdateAsync_ShouldTrackWarehouseAndIncludeZones_WhenWarehouseExistsAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetZonesByIdsAsync_ShouldReturnDistinctMatchingZones_WhenIdsContainDuplicatesAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var zone = await Phase2RepositoryTestData.AddZoneAsync(fixture, location.City);
    ...
    [Fact]
    public async Task GetZonesByIdsAsync_ShouldReturnEmptyList_WhenNoIdsMatchAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var result = await new WarehouseRepository(fixture.Context)
    ...
    [Fact]
    public async Task GetWarehouseGovernmentAsync_ShouldReturnWarehouseId_WhenZoneBelongsToGovernmentAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var zone = await Phase2RepositoryTestData.AddZoneAsync(fixture, location.City);
    ...
    [Fact]
    public async Task GetWarehouseGovernmentAsync_ShouldReturnNull_WhenGovernmentHasNoWarehouseAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task ExistsByNameAsync_ShouldMatchTrimmedNameIgnoringCase_WhenWarehouseExistsAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task ExistsByNameAsync_ShouldIgnoreExcludedWarehouse_WhenIdsMatchAsync()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
