...
namespace TransitNova.BusinessLayer.Services.ShipmentAssignmentServices
{
    ...
    {
        public async Task<string> AssignDelivery(Guid ShipmentId, Guid OperationManagerId, Guid CarrierId, CancellationToken cancellationToken)
        {
        ...
        public async Task<string> AssignPickup(Guid ShipmentId, Guid OperationManagerId, Guid CarrierId, CancellationToken cancellationToken)
        {
            //==== Check Existence Of The Shipment =========
