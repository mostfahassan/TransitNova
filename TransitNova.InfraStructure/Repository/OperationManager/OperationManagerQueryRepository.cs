...
namespace TransitNova.InfraStructure.Repository.OperationManager
{
    internal class OperationManagerQueryRepository(AppDbContext context) : IOperationManagerQueryRepository
    {
        ...
        public async Task<PagedResult<RetrieveShipmentSummaryDto>> RetrieveHandledShipmentsByOperationManager(Guid operationManagerId, int pageNumber, int pageSize, CancellationToken cancellationToken)
        {
        ...
        public async Task<PagedResult<CarrierSummaryDetailsDto>> RetrieveHandledCarriersByOperationManager(Guid operationManagerId, int pageNumber, int pageSize, CancellationToken cancellationToken)
        {
