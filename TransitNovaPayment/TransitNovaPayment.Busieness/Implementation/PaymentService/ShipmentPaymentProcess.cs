...
{
    internal class ShipmentPaymentProcess(
        ...
        ILogger<ShipmentPaymentProcess> logger) : IShipmentPayment
    {
        public async Task<BaseResult?> Pay(CreatePaymentDto dto, string publicKey, CancellationToken cancellationToken)
        {
            ...
            var createPayment = Payment.Create(totalAmount, dto.ReferenceId, dto.PaymentMethod, ReferenceType.Shipment);
