...
{
    [Fact]
    public async Task GetAppUserId_ShouldReturnProfileId_WhenProfileExists()
    {
        ...
        var result = await CreateRepository(fixture).GetAppUserId(user.AppUser.Id, default);
        result.Should().Be(user.Profile.Id);
    }

    [Fact]
    public async Task GetAppUserId_ShouldReturnEmptyGuid_WhenProfileDoesNotExist()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        (await CreateRepository(fixture).GetAppUserId(Guid.NewGuid(), default)).Should().BeEmpty();
    }

    [Fact]
    public async Task GetUserProfileAsync_ShouldProjectLocationAndIdentityFields_WhenProfileExists()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var user = await Phase2RepositoryTestData.AddUserAsync(fixture, location.City);
    ...
    [Fact]
    public async Task GetUserProfileAsync_ShouldReturnNull_WhenProfileDoesNotExist()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetUsersList_ShouldReturnEveryProfile_WhenMultipleUsersExist()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        ...
        (await CreateRepository(fixture).GetUsersList(default)).Should().HaveCount(2);
    }
    ...
    public async Task FilterUsersAsync_ShouldApplyTextCriterion_WhenCriterionMatches(
    ...
    [Fact]
    public async Task FilterUsersAsync_ShouldUseDefaultPagination_WhenValuesAreNonPositive()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetUserDetailsForAdminAsync_ShouldReturnLockoutAndProfileData_WhenUserExists()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var user = await Phase2RepositoryTestData.AddUserAsync(fixture, location.City);
    ...
    [Fact]
    public async Task GetShipmentCountInStatusAsync_ShouldReturnEmptyDictionary_WhenUserHasNoShipments()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task GetShipmentCountInStatusAsync_ShouldGroupOwnedShipments_WhenShipmentExists()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var user = await Phase2RepositoryTestData.AddUserAsync(fixture, location.City);
    ...
    [Fact]
    public async Task OwnsShipmentAsync_ShouldReturnTrue_WhenShipmentBelongsToUser()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        var location = await Phase2RepositoryTestData.AddLocationAsync(fixture);
        var user = await Phase2RepositoryTestData.AddUserAsync(fixture, location.City);
    ...
    [Fact]
    public async Task OwnsShipmentAsync_ShouldReturnFalse_WhenShipmentDoesNotBelongToUser()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        (await new UserRulesRepository(fixture.Context)
