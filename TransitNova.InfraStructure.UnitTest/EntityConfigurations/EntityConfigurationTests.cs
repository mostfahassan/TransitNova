...
{
    [Fact]
    public async Task CountryConfiguration_NameAndGovernmentRelationship_Should_EnforceConfiguredMetadata()
    {
    ...
    [Fact]
    public async Task CityConfiguration_GovernmentAndNameIndex_Should_BeCompositeAndUnique()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task ZoneConfiguration_CityRelationshipAndWarehouseNavigation_Should_BeConfigured()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task VehicleConfiguration_PlateCarrierAndType_Should_EnforceConstraintsAndConversions()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
        ...
        carrierForeignKey.DeleteBehavior.Should().Be(DeleteBehavior.SetNull);
        carrierForeignKey.IsUnique.Should().BeTrue();
        entity.GetDeclaredQueryFilters().Should().NotBeEmpty();
    }

    [Fact]
    public async Task RefreshTokenConfiguration_TokenAndActiveFilter_Should_EnforceUniquenessAndFiltering()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task SystemActivityLogConfiguration_DescriptionActorAndIndexes_Should_MatchAuditContract()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task IdempotentTableConfiguration_RequestIdAndInstanceName_Should_EnforceIdempotencyShape()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task ShipmentConfiguration_OwnedSpecificationAndOperationalIndexes_Should_BeConfigured()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
    ...
    [Fact]
    public async Task BundleConfiguration_NameAndOperationalIndexes_Should_EnforceConfiguredMetadata()
    {
        await using var fixture = await SqliteAppDbContextFixture.CreateAsync();
