...
namespace TransitNova.Api.Controllers.User.UserShipmentOperations
{
    ...
    public class UserShipmentsCreation(IMediator mediator) : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateShipment([FromHeader(Name ="X-Idempotency-Key")]string requestId ,[FromBody] CreateShipmentDto dto, CancellationToken ct)
        {
