...
namespace TransitNova.Domain.Entities.MainEntities
{
    public class ReportRequest : AggregateRoot<Guid>
    {
        ...
        private ReportRequest(ReportType reportType, Dictionary<string, string> parameters, Guid requestedBy)
        {
        ...
        public static ReportRequest CreateReport(ReportType reportType, Dictionary<string, string> parameters, Guid requestedBy)
        {
            var report = new ReportRequest(reportType, parameters, requestedBy);
            report.RaiseDomainEvent(new ReportRequestCreatedEvent(report.Id, report.ReportType, report.Parameters));
            return report;
        }
