...
namespace TransitNova.BusinessLayer.Common.Events.CarrierEventsHandler
{
        ...
        : INotificationHandler<CarrierRatedDomainEvent>
    {
        ...
        {
            var notificationCreated = Notification.Create(notification.AppUserId, "New Rating Received", $"You received a {notification.Rating}-star rating. Your average rating is now {notification.AverageRating:0.0}.");
