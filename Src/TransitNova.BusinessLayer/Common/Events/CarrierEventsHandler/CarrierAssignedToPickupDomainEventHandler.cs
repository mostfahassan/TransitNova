...
namespace TransitNova.BusinessLayer.Common.Events.CarrierEventsHandler
{
        ...
        : INotificationHandler<CarrierAssignedToPickupDomainEvent>
    {
        ...
        {
            var notificationCreated = Notification.Create(notification.AppUserId, "Pickup Assigned", $"A pickup shipment has been assigned to you. Active assignments: {notification.AssignedShipmentsCount}.");
