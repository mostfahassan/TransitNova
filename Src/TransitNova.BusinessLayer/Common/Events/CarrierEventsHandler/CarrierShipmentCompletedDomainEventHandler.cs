...
namespace TransitNova.BusinessLayer.Common.Events.CarrierEventsHandler
{
        ...
        : INotificationHandler<CarrierShipmentCompletedDomainEvent>
    {
        ...
        {
            var notificationCreated = Notification.Create(notification.AppUserId, "Shipment Completed", $"Shipment completed successfully. Total completed shipments: {notification.CompletedShipmentCount}.");
