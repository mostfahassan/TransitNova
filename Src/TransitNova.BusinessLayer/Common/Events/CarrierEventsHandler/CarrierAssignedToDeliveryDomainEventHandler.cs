...
namespace TransitNova.BusinessLayer.Common.Events.CarrierEventsHandler
{
        ...
        : INotificationHandler<CarrierAssignedToDeliveryDomainEvent>
    {
        ...
        {
            var notificationCreated = Notification.Create(notification.AppUserId, "Delivery Assigned", $"A delivery shipment has been assigned to you. Active assignments: {notification.AssignedShipmentsCount}.");
