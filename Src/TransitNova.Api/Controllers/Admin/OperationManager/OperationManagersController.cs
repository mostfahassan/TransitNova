...
namespace TransitNova.Api.Controllers.Admin.OperationManager
{
    ...
    public sealed class OperationManagersController(IMediator mediator) : ControllerBase
    {
        ...
        public async Task<IActionResult> OperationManagersAsync(CancellationToken ct)
        {
        ...
        public async Task<IActionResult> ActiveOperationManagersAsync(CancellationToken ct)
        {
