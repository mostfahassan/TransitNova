    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BundleName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    BundleDescription = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    ...
                    MaxShipmentsPerMonth = table.Column<int>(type: "int", nullable: false),
                    MaxWeightPerShipment = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MaxDistancePerShipment = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DiscountPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 18, scale: 2, nullable: false),
                    MinimumShipmentValueForDiscount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    hashedRequest = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address_MainAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    Address_SecondaryAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    Address_Street = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    UserType = table.Column<string>(type: "nvarchar(6)", maxLength: 6, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperationManagerProfiles", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "WarehouseManagersProfiles",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AppUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WarehouseManagersProfiles", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_WarehouseManagersProfiles_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WarehouseManagersProfiles_Cities_CityId",
                        column: x => x.CityId,
                        principalTable: "Cities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReferecneId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CustomerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Cost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Commission = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    Amount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ReferecneType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    PaymentMethod = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Status = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PaidAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    BundleSubscriptionId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BundleId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    BundleName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: true),
                    OriginalShippingCost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DiscountPercentage = table.Column<decimal>(type: "decimal(5,2)", precision: 18, scale: 2, nullable: false),
                    DiscountAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    FinalShippingCost = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    SubscriptionBenefitApplied = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PaymentInvoices", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_PaymentInvoices_UserProfiles_CustomerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Warehouses", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_Warehouses_WarehouseManagersProfiles_ManagerId",
                        column: x => x.ManagerId,
                        principalTable: "WarehouseManagersProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAddress_MainAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DeliveryAddress_SecondaryAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    DeliveryAddress_Street = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    PickupAddress_MainAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    PickupAddress_SecondaryAddress = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true),
                    PickupAddress_Street = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Shipments", x => x.Id)
                        .Annotation("SqlServer:Clustered", true);
                    table.ForeignKey(
                        name: "FK_Shipments_OperationManagerProfiles_HandlerId",
                        column: x => x.HandlerId,
                        principalTable: "OperationManagerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ShipmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    StatusType = table.Column<string>(type: "nvarchar(25)", maxLength: 25, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IdempotentTableKey_RequestId",
                table: "IdempotentTableKey",
                column: "RequestId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutboxMessages_OccuredAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_BundleId",
                table: "PaymentInvoices",
                column: "BundleId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_BundleSubscriptionId",
                table: "PaymentInvoices",
                column: "BundleSubscriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_CreatedAt",
                table: "PaymentInvoices",
                column: "CreatedAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_CustomerId_BundleId_SubscriptionBenefitApplied_CreatedAt",
                table: "PaymentInvoices",
                columns: new[] { "CustomerId", "BundleId", "SubscriptionBenefitApplied", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_CustomerId_Status",
                table: "PaymentInvoices",
                columns: new[] { "CustomerId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_PaidAt",
                table: "PaymentInvoices",
                column: "PaidAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_ReferecneId",
                table: "PaymentInvoices",
                column: "ReferecneId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentInvoices_ReferecneId_Status",
                table: "PaymentInvoices",
                columns: new[] { "ReferecneId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseManagersProfiles_AppUserId",
                table: "WarehouseManagersProfiles",
                column: "AppUserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseManagersProfiles_CityId",
                table: "WarehouseManagersProfiles",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseManagersProfiles_Email",
                table: "WarehouseManagersProfiles",
                column: "Email");
