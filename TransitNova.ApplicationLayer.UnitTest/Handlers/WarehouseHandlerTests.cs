...
{
    [Fact]
    public async Task CreateWarehouseHandler_Should_ReturnValidationAndSkipWrites_When_AnyZoneIsMissing()
    {
    ...
    [Fact]
    public async Task CreateWarehouseHandler_Should_DeduplicateZonesPersistLogAndReturnCreated_When_RequestIsValid()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task CreateWarehouseHandler_Should_ReturnFailure_When_CreatedWarehouseCannotBeRetrieved()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task UpdateWarehouseHandler_Should_ReturnNotFoundAndSkipWrites_When_WarehouseDoesNotExist()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task UpdateWarehouseHandler_Should_ReturnValidationAndSkipWrites_When_AnyZoneIsMissing()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task UpdateWarehouseHandler_Should_UpdateZonesLogAndCommit_When_RequestIsValid()
    {
        var fixture = new Fixture();
        var adminId = Guid.NewGuid();
    ...
    [Fact]
    public async Task DeleteWarehouseHandler_Should_ReturnNotFoundAndSkipLog_When_WarehouseDoesNotExist()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task DeleteWarehouseHandler_Should_LogAndCommit_When_WarehouseExists()
    {
        var fixture = new Fixture();
    ...
    [Fact]
    public async Task GetWarehouseByIdHandler_Should_ReturnValidationFailure_When_IdIsEmpty()
    {
    ...
    public async Task GetWarehouseByIdHandler_Should_ReturnExpectedResult_When_RepositoryResultIsKnown(bool exists, ResultStatus expectedStatus)
    {
        var warehouseId = Guid.NewGuid();
        var queries = new Mock<IWarehouseQueriesRepository>();
    ...
    [Fact]
    public async Task GetWarehouseListHandler_Should_ReturnEmptySuccess_When_NoWarehousesExist()
    {
        var queries = new Mock<IWarehouseQueriesRepository>();
