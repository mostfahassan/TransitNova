...
{
    [Fact]
    public async Task Handle_Should_ReturnNotFoundAndSkipWrites_When_ShipmentDoesNotExist()
    {
        var fixture = new Fixture();
        fixture.Shipments.Setup(x => x.GetShipmentForCommands(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task Handle_Should_CancelLogPersistAndInvalidateCaches_When_ShipmentExists()
    {
        var fixture = new Fixture();
        var shipment = CreateShipment();
        var userId = Guid.NewGuid();
        fixture.Shipments.Setup(x => x.GetShipmentForCommands(shipment.Id, It.IsAny<CancellationToken>())).ReturnsAsync(shipment);
    ...
    [Fact]
    public async Task Handle_Should_ThrowDomainException_When_PersistenceReturnsNegativeResult()
    {
        var fixture = new Fixture();
        var shipment = CreateShipment();
        var userId = Guid.NewGuid();
