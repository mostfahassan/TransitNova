...
{
    [Fact]
    public async Task Handle_Should_CreateBundleAndInvalidateCache_When_CommandIsValid()
    {
    ...
    [Fact]
    public async Task UpdateBundleHandler_Should_ReturnFailureAndSkipWrites_When_BundleDoesNotExist()
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
    ...
    [Fact]
    public async Task UpdateBundleHandler_Should_UpdatePersistAndInvalidateCaches_When_BundleExists()
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
        var managers = new Mock<IOperationManagerQueryRepository>();
        var unitOfWork = new Mock<IUnitOfWork>();
    ...
    [Fact]
    public async Task DeleteBundleHandler_Should_DeletePersistAndInvalidateCaches_When_CommandIsHandled()
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
        var unitOfWork = new Mock<IUnitOfWork>();
        var cache = new Mock<ICacheService>();
    ...
    public async Task GetBundleByIdHandler_Should_ReturnExpectedResult_When_RepositoryResultIsKnown(bool exists, ResultStatus expectedStatus)
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
        var id = Guid.NewGuid();
    ...
    [Fact]
    public async Task GetBundleListHandler_Should_ReturnEmptySuccess_When_NoBundlesExist()
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
    ...
    [Fact]
    public async Task GetBundleListHandler_Should_ReturnRepositoryList_When_BundlesExist()
    {
        var repository = new Mock<IGenericRepository<Bundle, Guid>>();
