...
{
    [Fact]
    public async Task CreateVehicleHandler_Should_CreateTrimAndReturnVehicle_When_RequestIsValid()
    {
    ...
    [Fact]
    public async Task CreateVehicleHandler_Should_ReturnFailure_When_CreatedVehicleCannotBeRetrieved()
    {
        var repository = new Mock<IVehicleQueryRepository>();
        var unitOfWork = SuccessfulUnitOfWork();
        repository.Setup(x => x.GetByIdAsync<VehicleDto>(It.IsAny<Guid>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task UpdateVehicleHandler_Should_UpdateVehicleAndCarrier_When_RequestIsValid()
    {
    ...
    [Fact]
    public async Task UpdateVehicleHandler_Should_ReturnNotFoundAndSkipCommit_When_VehicleDoesNotExist()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task DeleteVehicleHandler_Should_DeleteAndCommit_When_CommandIsHandled()
    {
        var id = Guid.NewGuid();
        var repository = new Mock<IVehicleQueryRepository>();
        var unitOfWork = SuccessfulUnitOfWork();
    ...
    [Fact]
    public async Task GetVehicleByIdHandler_Should_ReturnValidationFailure_When_IdIsEmpty()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    public async Task GetVehicleByIdHandler_Should_ReturnExpectedResult_When_RepositoryResultIsKnown(bool exists, ResultStatus expectedStatus)
    {
        var id = Guid.NewGuid();
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetVehicleByPlateNumberHandler_Should_ValidateBlankPlateWithoutRepositoryCall()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetVehicleByPlateNumberHandler_Should_TrimPlateAndReturnVehicle_When_Found()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetVehicleListHandler_Should_ReturnEmptySuccess_When_NoVehiclesExist()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetActiveVehiclesHandler_Should_ReturnRepositoryVehicles_When_ActiveVehiclesExist()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetVehiclesByCarrierIdHandler_Should_ReturnNotFoundWithoutRepositoryCall_When_CarrierIdIsEmpty()
    {
        var repository = new Mock<IVehicleQueryRepository>();
    ...
    [Fact]
    public async Task GetVehiclesByCarrierIdHandler_Should_ReturnEmptySuccess_When_CarrierHasNoVehicles()
    {
