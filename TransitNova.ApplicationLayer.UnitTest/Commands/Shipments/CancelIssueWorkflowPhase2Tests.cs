...
{
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentExists_ShouldTransitionToCancelled()
    {
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentExists_ShouldSetCancellationTimestamp()
    {
        var fixture = new CancellationFixture();
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentExists_ShouldCreateCancelledActivityLog()
    {
        var fixture = new CancellationFixture();
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentExists_ShouldSaveAndInvalidateSevenCaches()
    {
        var fixture = new CancellationFixture();
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentDoesNotExist_ShouldReturnNotFoundWithoutSaving()
    {
        var fixture = new CancellationFixture();
        fixture.Shipments.Setup(x => x.GetShipmentForCommands(
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenShipmentIsDelivered_ShouldPropagateInvalidTransitionWithoutSaving()
    {
    ...
    [Fact]
    public async Task CancelShipmentHandler_WhenSaveReportsNegativeResult_ShouldThrowDomainOperationException()
    {
        var fixture = new CancellationFixture();
    ...
    [Fact]
    public async Task IssueShipmentHandler_WhenDeliveredShipmentExists_ShouldTransitionToIssue()
    {
    ...
    [Fact]
    public async Task IssueShipmentHandler_WhenDeliveredShipmentExists_ShouldPersistIssueMessageAndTimestamp()
    {
        var fixture = new IssueFixture();
    ...
    [Fact]
    public async Task IssueShipmentHandler_WhenDeliveredShipmentExists_ShouldSaveAndInvalidateSevenCaches()
    {
        var fixture = new IssueFixture();
    ...
    public async Task IssueShipmentHandler_WhenShipmentIsNotDelivered_ShouldPropagateInvalidStateWithoutSaving(
    ...
    private sealed class CancellationFixture
    {
        ...
        public CancellationFixture(Shipment? shipment = null)
        {
            ...
            Shipments.Setup(x => x.GetShipmentForCommands(Shipment.Id, It.IsAny<CancellationToken>()))
