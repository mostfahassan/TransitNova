...
{
    [Fact]
    public async Task CompleteShipmentToWarehouseHandler_WhenServiceCompletesShipment_ShouldReturnSuccess()
    {
    ...
    [Fact]
    public async Task CompleteShipmentToWarehouseHandler_WhenCalled_ShouldForwardShipmentAndCarrierIds()
    {
        var fixture = new WarehouseCompletionFixture();
    ...
    [Fact]
    public async Task CompleteShipmentToWarehouseHandler_WhenServiceCompletesShipment_ShouldSaveOnce()
    {
        var fixture = new WarehouseCompletionFixture();
    ...
    [InlineData(true, 7)]
    [InlineData(false, 6)]
    public async Task CompleteShipmentToWarehouseHandler_WhenTripPresenceVaries_ShouldInvalidateExpectedCaches(
        bool hasTrip,
    ...
    [Fact]
    public async Task CompleteShipmentToWarehouseHandler_WhenServiceFails_ShouldPropagateWithoutSaving()
    {
        var fixture = new WarehouseCompletionFixture();
    ...
    [Fact]
    public async Task CompleteShipmentCommandHandler_WhenServiceDeliversShipment_ShouldReturnSuccess()
    {
    ...
    [Fact]
    public async Task CompleteShipmentCommandHandler_WhenCalled_ShouldForwardShipmentAndCarrierIds()
    {
        var fixture = new DeliveryCompletionFixture();
    ...
    [Fact]
    public async Task CompleteShipmentCommandHandler_WhenServiceDeliversShipment_ShouldSaveOnce()
    {
        var fixture = new DeliveryCompletionFixture();
    ...
    [InlineData(true, 7)]
    [InlineData(false, 6)]
    public async Task CompleteShipmentCommandHandler_WhenTripPresenceVaries_ShouldInvalidateExpectedCaches(
        bool hasTrip,
        int expectedCacheCalls)
    {
    ...
    [Fact]
    public async Task CompleteShipmentCommandHandler_WhenServiceFails_ShouldPropagateWithoutSaving()
    {
        var fixture = new DeliveryCompletionFixture();
