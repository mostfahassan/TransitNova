...
{
    [Fact]
    public async Task ApproveShipmentHandler_WhenShipmentIsPending_ShouldTransitionToApproved()
    {
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenShipmentIsPending_ShouldRecordOperationManagerIdentity()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenShipmentIsPending_ShouldCreateApprovedActivityLog()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenShipmentIsPending_ShouldSaveOnce()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenShipmentIsPending_ShouldInvalidateThreeCaches()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenPendingShipmentDoesNotExist_ShouldReturnNotFoundWithoutSaving()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenRepositoryReturnsNonPendingShipment_ShouldPropagateInvalidTransitionWithoutSaving()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task ApproveShipmentHandler_WhenCancellationTokenIsPassed_ShouldForwardIt()
    {
        var fixture = new ApprovalFixture();
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenShipmentIsPending_ShouldTransitionToRejected()
    {
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenShipmentIsPending_ShouldPersistRejectionReason()
    {
        var fixture = new RejectionFixture();
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenShipmentIsPending_ShouldCreateRejectedActivityLog()
    {
        var fixture = new RejectionFixture();
        SystemActivityLog? captured = null;
        fixture.Logs.Setup(x => x.Log(It.IsAny<SystemActivityLog>(), It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenShipmentIsPending_ShouldSaveOnce()
    {
        var fixture = new RejectionFixture();
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenShipmentIsPending_ShouldInvalidateThreeCaches()
    {
        var fixture = new RejectionFixture();
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenPendingShipmentDoesNotExist_ShouldReturnNotFoundWithoutSaving()
    {
        var fixture = new RejectionFixture();
        fixture.Shipments.Setup(x => x.GetShipmentInStatusAsync(
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenRepositoryReturnsNonPendingShipment_ShouldPropagateInvalidTransitionWithoutSaving()
    {
        var fixture = new RejectionFixture();
        fixture.Shipment.ApproveShipment(Guid.NewGuid());
    ...
    [Fact]
    public async Task RejectShipmentHandler_WhenCancellationTokenIsPassed_ShouldForwardIt()
    {
        var fixture = new RejectionFixture();
        using var cancellation = new CancellationTokenSource();
