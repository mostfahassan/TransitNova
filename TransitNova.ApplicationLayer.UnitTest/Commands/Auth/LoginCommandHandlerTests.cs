...
{
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldReturnAuthenticatedResponse()
    {
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldReturnAccessAndRefreshTokens()
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldReturnCorrectUserIdentity()
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldPersistRefreshToken()
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldSaveBeforeReturning()
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreValid_ShouldLoadRolesBeforeGeneratingToken()
    {
        var fixture = new LoginFixture();
    ...
    public async Task LoginHandler_WhenValidationDoesNotProduceValidUser_ShouldReturnSameInvalidCredentialsError(
        bool valid,
        bool returnNullUser)
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCredentialsAreInvalid_ShouldNotGenerateTokens()
    {
        var fixture = new LoginFixture();
        fixture.Rules.Setup(x => x.ValidatePasswordAsync(
        ...
        fixture.TokenProvider.Verify(x => x.GenerateToken(It.IsAny<AppUserDto>()), Times.Never);
    }

    [Fact]
    public async Task LoginHandler_WhenRefreshTokenPersistenceFails_ShouldPropagateWithoutSaving()
    {
        var fixture = new LoginFixture();
    ...
    [Fact]
    public async Task LoginHandler_WhenCancellationTokenIsPassed_ShouldForwardItToDependencies()
    {
        var fixture = new LoginFixture();
    ...
    private sealed class LoginFixture
    {
        ...
        public LoginFixture()
        {
            Command = new LoginCommand(Guid.NewGuid(), Dto);
