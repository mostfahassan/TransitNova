...
{
    [Fact]
    public async Task GenerateRefreshTokenHandler_WhenServiceReturnsTokens_ShouldReturnAuthenticatedResponse()
    {
    ...
    [Fact]
    public async Task GenerateRefreshTokenHandler_WhenServiceReturnsTokens_ShouldReturnRotatedTokens()
    {
        var fixture = new RefreshFixture();
    ...
    [Fact]
    public async Task GenerateRefreshTokenHandler_WhenServiceReturnsTokens_ShouldReturnUserAndRoles()
    {
        var fixture = new RefreshFixture();
    ...
    [Fact]
    public async Task GenerateRefreshTokenHandler_WhenCalled_ShouldForwardTokenAndCancellation()
    {
        var fixture = new RefreshFixture();
    ...
    [Fact]
    public async Task GenerateRefreshTokenHandler_WhenTokenServiceFails_ShouldPropagateException()
    {
        var fixture = new RefreshFixture();
