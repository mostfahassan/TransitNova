...
{
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldReturnAuthenticatedResponse()
    {
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldMapRegistrationDto()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldCreateIdentityUserWithProvidedPassword()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldAssignRequestedRole()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldExecuteResolvedProfileStrategy()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldPersistGeneratedRefreshToken()
    {
        var fixture = new RegistrationFixture();
    ...
    public async Task RegistrationHandler_WhenRegistrationSucceeds_ShouldLogCorrectBusinessEntity(
        UserType userType,
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldSaveChangesOnce()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenRegistrationIsValid_ShouldGenerateAccessTokenAfterRolesAreLoaded()
    {
        var fixture = new RegistrationFixture();

        var result = await fixture.Handler.Handle(fixture.Command, CancellationToken.None);

        fixture.TokenProvider.Verify(x => x.GenerateToken(
    ...
    [Fact]
    public async Task RegistrationHandler_WhenUserTypeHasNoStrategy_ShouldReturnFailureWithoutSaving()
    {
        var fixture = new RegistrationFixture();
    ...
    [Fact]
    public async Task RegistrationHandler_WhenIdentityCreationFails_ShouldPropagateWithoutSaving()
    {
        var fixture = new RegistrationFixture();
    ...
    private sealed class RegistrationFixture
    {
        ...
        public RegistrationFixture(UserType userType = UserType.User)
        {
            ...
            Command = new RegistrationCommand(Guid.NewGuid(), Dto);
            ...
            TokenProvider.Setup(x => x.GenerateToken(It.IsAny<AppUserDto>())).ReturnsAsync(AccessToken);
