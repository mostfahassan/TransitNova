...
{
    [Fact]
    public async Task UpdateCarrierStatusCommandHandler_WhenRepositoryUpdatesRow_ShouldReturnSuccessAndInvalidateCaches()
    {
    ...
    [Fact]
    public async Task UpdateCarrierStatusCommandHandler_WhenRepositoryUpdatesNoRows_ShouldReturnCarrierNotFoundWithoutCacheInvalidation()
    {
        var repository = new Mock<ICarrierCommandRepository>();
        var cache = new Mock<ICacheService>();
    ...
    [Fact]
    public async Task DeleteCarrierHandler_WhenRepositoryDeletesRow_ShouldReturnSuccessAndInvalidateCaches()
    {
        var repository = new Mock<ICarrierCommandRepository>();
        var cache = new Mock<ICacheService>();
        var carrierId = Guid.NewGuid();
    ...
    [Fact]
    public async Task DeleteCarrierHandler_WhenRepositoryDeletesNoRows_ShouldReturnFailureWithoutCacheInvalidation()
    {
        var repository = new Mock<ICarrierCommandRepository>();
        var cache = new Mock<ICacheService>();
    ...
    public async Task IsCarrierAvailableQueryHandler_WhenAvailabilityIsKnown_ShouldReturnExpectedResult(bool available, ResultStatus expectedStatus)
    {
    ...
    [Fact]
    public async Task AddCarrierAdditionalInfoCommandHandler_WhenCarrierExists_ShouldUpdateSaveAndInvalidateCaches()
    {
    ...
    [Fact]
    public async Task AddCarrierAdditionalInfoCommandHandler_WhenAdditionalInfoAlreadyExists_ShouldPropagateDomainErrorWithoutSaving()
    {
        var userId = Guid.NewGuid();
        var carrier = CreateCarrier(userId);
