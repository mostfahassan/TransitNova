...
{
    [Fact]
    public async Task SubscribeToBundleHandler_MissingUser_Should_ReturnNotFoundWithoutLoadingBundle()
    {
        var fixture = new SubscriptionFixture();
        fixture.Users.Setup(x => x.GetAppUserId(fixture.UserId, It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task SubscribeToBundleHandler_MissingBundle_Should_ReturnNotFoundWithoutSaving()
    {
        var fixture = new SubscriptionFixture();
    ...
    [Fact]
    public async Task SubscribeToBundleHandler_ValidRequest_Should_SubscribeSaveAndInvalidateCaches()
    {
        var fixture = new SubscriptionFixture();
    ...
    [Fact]
    public async Task SubscribeToBundleHandler_AlreadySubscribedUser_Should_PropagateDomainExceptionWithoutSaving()
    {
        var fixture = new SubscriptionFixture();
    ...
    [Fact]
    public async Task UnSubscribeBundleHandler_MissingUser_Should_ReturnNotFoundWithoutLoadingBundle()
    {
        var fixture = new SubscriptionFixture();
        fixture.Users.Setup(x => x.GetAppUserId(fixture.UserId, It.IsAny<CancellationToken>()))
            .ReturnsAsync(Guid.Empty);
        ...
        var result = await fixture.CreateUnsubscribeHandler().Handle(
            new UnSubscribeBundleCommand(Guid.NewGuid(), fixture.UserId, fixture.Bundle.Id),
            CancellationToken.None);
    ...
    [Fact]
    public async Task UnSubscribeBundleHandler_MissingBundle_Should_ReturnNotFoundWithoutSaving()
    {
        var fixture = new SubscriptionFixture();
        fixture.ArrangeExistingUser();
        fixture.Bundles.Setup(x => x.GetByIdAsync<Bundle>(fixture.Bundle.Id, It.IsAny<CancellationToken>()))
    ...
    [Fact]
    public async Task UnSubscribeBundleHandler_NoActiveSubscription_Should_ReturnNotFoundWithoutSaving()
    {
        var fixture = new SubscriptionFixture();
        fixture.ArrangeExistingUserAndBundle();
    ...
    [Fact]
    public async Task UnSubscribeBundleHandler_ActiveSubscription_Should_DeactivateSaveAndInvalidateCaches()
    {
        var fixture = new SubscriptionFixture();
        fixture.Bundle.Subscribe(fixture.UserId);
        fixture.ArrangeExistingUserAndBundle();
    ...
    private sealed class SubscriptionFixture
    {
        ...
        public void ArrangeExistingUser() =>
            Users.Setup(x => x.GetAppUserId(UserId, It.IsAny<CancellationToken>()))
        ...
        public UnSubscribeBundleHandler CreateUnsubscribeHandler() => new(
            Bundles.Object,
            Users.Object,
            UnitOfWork.Object,
            Cache.Object,
            Mock.Of<ILogger<UnSubscribeBundleHandler>>());
