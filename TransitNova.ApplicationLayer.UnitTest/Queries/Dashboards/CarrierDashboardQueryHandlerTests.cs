...
{
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenCarrierDoesNotExist_ShouldReturnNotFoundWithoutLoadingMetrics()
    {
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenCarrierExists_ShouldReturnCarrierProfile()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenStatsExist_ShouldAggregateAssignedShipmentStatuses()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenTripsHaveMixedStatuses_ShouldReturnOnlyFiveActiveOrPlannedTrips()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenRevenueIsMissing_ShouldReturnZeroRevenue()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenRecentShipmentsExist_ShouldReturnRepositoryPageData()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenLoadingRecentShipments_ShouldRequestFirstTenItems()
    {
        var fixture = new CarrierDashboardFixture();
    ...
    [Fact]
    public async Task GetCarrierDashboardHandler_WhenCancellationTokenIsPassed_ShouldForwardItToEveryRepository()
    {
        var fixture = new CarrierDashboardFixture();
        ...
        fixture.Shipments.Verify(x => x.GetCarrierShipmentCountInStatus(fixture.Carrier.Id, cancellation.Token), Times.Once);
    ...
    private sealed class CarrierDashboardFixture
    {
        ...
        public CarrierDashboardFixture()
        {
            ...
            Shipments.Setup(x => x.GetCarrierShipmentCountInStatus(
