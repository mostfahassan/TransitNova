...
{
    [Fact]
    public async Task GetOperationManagerDashboardHandler_WhenRepositoryReturnsData_ShouldReturnSuccess()
    {
    ...
    [Fact]
    public async Task GetOperationManagerDashboardHandler_WhenRepositoryReturnsData_ShouldUseCurrentPageCountAsTotalShipments()
    {
        var fixture = new OperationDashboardFixture();
    ...
    public async Task GetOperationManagerDashboardHandler_WhenStatusCountExists_ShouldMapStatusCount(
    ...
    [Fact]
    public async Task GetOperationManagerDashboardHandler_WhenAssignedStatusesExist_ShouldAggregateActiveShipments()
    {
        var fixture = new OperationDashboardFixture();
    ...
    [Fact]
    public async Task GetOperationManagerDashboardHandler_WhenManyShipmentsExist_ShouldLimitRecentActivityToFive()
    {
        var fixture = new OperationDashboardFixture();
    ...
    [Fact]
    public async Task GetOperationManagerDashboardHandler_WhenCancellationTokenIsPassed_ShouldForwardIt()
    {
        var fixture = new OperationDashboardFixture();
        ...
        fixture.Repository.Verify(x => x.GetShipmentCountInStatus(cancellation.Token), Times.Once);
    }
    ...
    private sealed class OperationDashboardFixture
    {
        ...
        public OperationDashboardFixture()
        {
            ...
            Repository.Setup(x => x.GetShipmentCountInStatus(It.IsAny<CancellationToken>()))
                .ReturnsAsync(Stats);
