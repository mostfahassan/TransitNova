...
{
    [Fact]
    public async Task GetAdminDashboardHandler_WhenServiceBuildsDashboard_ShouldReturnSuccess()
    {
    ...
    [Fact]
    public async Task GetAdminDashboardHandler_WhenServiceBuildsDashboard_ShouldReturnSameDashboardInstance()
    {
        var fixture = new AdminDashboardFixture();
    ...
    [Fact]
    public async Task GetAdminDashboardHandler_WhenServiceBuildsDashboard_ShouldPreserveKpis()
    {
        var fixture = new AdminDashboardFixture();
    ...
    [Fact]
    public async Task GetAdminDashboardHandler_WhenServiceBuildsDashboard_ShouldPreserveRevenue()
    {
        var fixture = new AdminDashboardFixture();
    ...
    [Fact]
    public async Task GetAdminDashboardHandler_WhenCancellationTokenIsPassed_ShouldForwardIt()
    {
        var fixture = new AdminDashboardFixture();
    ...
    [Fact]
    public async Task GetAdminDashboardHandler_WhenDashboardServiceFails_ShouldPropagateException()
    {
        var fixture = new AdminDashboardFixture();
