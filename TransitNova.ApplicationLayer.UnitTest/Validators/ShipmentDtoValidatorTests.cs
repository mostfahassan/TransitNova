...
{
    [Fact]
    public async Task CreateReceiverValidator_CompleteReceiver_Should_BeValid()
    {
    ...
    [InlineData("address")]
    [InlineData("city")]
    public async Task CreateReceiverValidator_InvalidProfileField_Should_BeInvalid(string field)
    {
    ...
    [Fact]
    public async Task PackageSpecificationValidator_PositiveDimensions_Should_BeValid()
    {
    ...
    [InlineData("height")]
    [InlineData("length")]
    public async Task PackageSpecificationValidator_NonPositiveDimension_Should_BeInvalid(string dimension)
    {
    ...
    [Fact]
    public async Task CreateShipmentValidation_CompleteShipment_Should_BeValid()
    {
    ...
    public async Task CreateShipmentValidation_InvalidEnum_Should_BeInvalid(string field)
    {
    ...
    [InlineData("receiver")]
    [InlineData("package")]
    public async Task CreateShipmentValidation_MissingOrConflictingRequiredData_Should_BeInvalid(string field)
    {
        var shipment = ValidShipment();
        shipment = field switch
        {
    ...
    [InlineData("delivery")]
    [InlineData("pickup")]
    public async Task CreateShipmentValidation_AddressOverMaximumLength_Should_BeInvalid(string field)
    {
        var shipment = ValidShipment();
